...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.php">Cv Maker</a>
                ...
                <div class="form-row">
                   ...
                   <div class="col-md-5 left">
                        <select name="city" class="form-control">
                          <option value="Ranchi" <?php if ($ct=="Ranchi") {
                          echo "selected";
                        } ?> >Ranchi</option>
                          <option value="Aurangabad" <?php if ($ct=="Aurangabad") {
                            echo "selected";
                          } ?>>Aurangabad</option>
                          <option value="Daudnagar" <?php if ($ct=="Daudnagar") {
                  echo "selected";
                } ?>>Daudnagar</option>
                        </select>
                  </div>
                ...
                <div class="form-row">
                   ...
                   <div class="col-md-5 left">
                        <select name="state" class="form-control">
                            <option value="Jharkhand"  <?php if ($stat=="Jharkhand") {
                            echo "selected";
                          } ?>>Jharkhand</option>
                          <option value="Bihar"  <?php if ($stat=="Bihar") {
                          echo "selected";
                        } ?>>Bihar</option>
                            <option value="Bihar"  <?php if ($stat=="Bihar") {
                          echo "selected";
      ...
      <footer class="sticky-footer">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright © Hari Om 2024</span>
          </div>
        </div>
      </footer>
